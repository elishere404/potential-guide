  ...
  return (
   ...
   <div class="bg-white font-semibold text-center rounded-3xl border shadow-lg p-10 max-w-xs">
     ...
     <div className="flex flex-row justify-center items-center gap-4">
      <a href="https://github.com/elishere404"><img src="https://ibb.co/S0Nj3L1" alt="github" /></a>
      <a href="mailto:hilariousaction@gmail.com"><img src="https://ibb.co/Vqf7FvW" alt="gmail" /></a>
     </div>
   </div>
 </div>
    </>
